...
echo '
    <a href="openid-auth.php?openid_identifier=https://www.google.com/accounts/o8/id"><img src=google-button.png></a> 
    <a href="openid-auth.php?openid_identifier=http://yahoo.com"><img src=yahoo-button.png></a>
    ';

echo "<br>";

//echo "Or log in with your Open-ID credentials";
//echo '
//<form action="openid-auth.php" method="post">
